...
return {
  ...
  opts = {
    -- style = "~/.config/nvim/plugins/Utility/", -- "auto" tries to detect your Neovim background option. Possible values: "dark", "light", "auto"
    style = "~/.config/nvim/plugins/Utility/glowstyle.json", -- filled automatically with your current editor background, you can override using glow json style
    -- style = "~/.config/nvim/plugins/Utility/glowstyle.json", -- "auto" tries to detect your Neovim background option. Possible values: "dark", "light", "auto"
