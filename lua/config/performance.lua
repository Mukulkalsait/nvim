...
vim.opt.redrawtime = 500 -- vim.opt.redrawtime = 1500 -- less time spent redrawing the screen
vim.opt.cursorline = true --disable coursorline :performance
...
vim.o.cursorline = true -- Disable cursorline for performance
vim.o.ruler = true -- Disable ruler for performance
